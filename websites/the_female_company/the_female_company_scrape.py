def the_female_company():
    # import libraries
    import os
    import pickle
    import requests

    company_name = "the_female_company"
    ...
    url = "https://thefemalecompany.jobs.personio.de/search.json"
    ...
    for job in job_listings:
        id = job['id']
        title = job['name']
        link = f'https://thefemalecompany.jobs.personio.de/job/{id}'
        location = job['office']
